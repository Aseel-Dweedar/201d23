...
function twinQ() {
  ...
  while (
    ...
    answer1 = prompt(
      "please enter yes or no, Do you think I have a twin?"
    ).toLowerCase();
  }
...
function healthQ() {
  ...
  while (
    ...
    answer3 = prompt(
      "please enter yes or no, Do you think i am Healthy and sporty?"
    ).toLowerCase();
  }
...
function travelQ() {
  ...
  while (
    ...
    answer4 = prompt(
      "please enter yes or no, Do you think I travel before?"
    ).toLowerCase();
  }
...
function ghostsQ() {
  ...
  while (
    ...
    answer5 = prompt(
      "please enter yes or no, Do you think I believe in ghosts?"
    ).toLowerCase();
  }
...
function monthQ() {
  let guessName = prompt(
    "I have 3 favorite months, Can you guess one of them?"
  ).toLowerCase();
  let d;
  ...
  for (d = 0; d < 5; d++) {
    if (
      ...
      alert(
        "That is correct ^-^, My favorite months are, April, September & November"
      );
      score++;
      d = d + 5;
    } else {
  ...
  if (d == 5) {
    if (
      ...
      alert(
        "Unfortunately, But My favorite months are, April, September & November"
      );
    }
  }
}
